...
var TimeInput = _react2.default.createClass({
    ...
    handleHourChange: function handleHourChange(event) {
        if (this.props.selectedDate) {
            var newSelectedDate = new Date(this.props.selectedDate);
            newSelectedDate.setHours(event.target.value);
            this.props.onChange(newSelectedDate);
        }
    },
    handleMinuteChange: function handleMinuteChange(event) {
        if (this.props.selectedDate) {
            var newSelectedDate = new Date(this.props.selectedDate);
    ...
    handleFormatChange: function handleFormatChange(event) {
        if (this.props.selectedDate) {
            var newSelectedDate = new Date(this.props.selectedDate);
            var hours = newSelectedDate.getHours();
    ...
    renderOption: function renderOption(option, key) {
        return _react2.default.createElement(
            'option',
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'select',
                            { name: 'hour', className: 'form-control', value: currentHour, style: { padding: "6px 12px", textAlign: 'center' }, onChange: this.handleHourChange },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'select',
                            { name: 'minutes', className: 'form-control', value: currentMinute, style: { padding: "6px 12px", textAlign: 'center' }, onChange: this.handleMinuteChange },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'select',
                            { name: 'format', className: 'form-control', value: currentFormat, style: { padding: "6px 12px", textAlign: 'center' }, onChange: this.handleFormatChange },
                            _react2.default.createElement(
                                'option',
                                { value: 'am' },
                                'AM'
...
exports.default = _react2.default.createClass({
    ...
    propTypes: {
        ...
        timeFormat: _react2.default.PropTypes.bool
    },
    ...
    makeInputValueString: function makeInputValueString(date) {
        ...
        var currentFormat = 'am';
        if (currentHour > 12) {
            currentFormat = 'pm';
        }
        currentHour = currentHour % 12 || 12;
        var hour = (currentHour < 10 ? '0' : '') + currentHour;
    ...
    onApplyDate: function onApplyDate() {
        this.setState({
            focused: false
        });
        if (this.props.onChange) {
    ...
    renderTime: function renderTime() {
        if (this.props.timeFormat) {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(TimeInput, { selectedDate: this.state.selectedDate, onChange: this.onChangeDate }),
                _react2.default.createElement(
                    'button',
                    { className: 'btn btn-xs btn-block btn-primary', onClick: this.onApplyDate },
                    'Apply'
                )
            );
        }
